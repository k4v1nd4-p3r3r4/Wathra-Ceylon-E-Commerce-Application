...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Wasthra Ceylon">
    <meta name="msapplication-TileImage" content="{{asset('assets/images/logo1.png')}}">
    <meta name="msapplication-TileColor" content="#FFFFFF">


    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Wasthra Ceylon">
    <meta name="keywords" content="Wasthra Ceylon">
    <meta name="author" content="Wasthra Ceylon">
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}">
                                        <img src="{{asset('assets/images/logo1.png')}}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('shop.index')}}" class="nav-link menu-title">Everything</a></li>
                                            <li><a href="about-us.html" class="nav-link menu-title">About</a></li>
                                            <li><a href="contact-us.html" class="nav-link menu-title">Contact</a>
                                            </li>
                                                      ...
                                                      @endif
                                                        <li>
                                                            <a href="{{ route('logout') }}"
                                                                ...
                                                                document.getElementById('frmlogout').submit();" class="d-block">Logout
                                                            </a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +94 11 379 675</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Kamburupitiya, Matara,
                                            Sri Lanka</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> wasthraceylon@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="shop.html" class="font-dark">Foods</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Hand Craft</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Food Packages</a>
                                    </li>
